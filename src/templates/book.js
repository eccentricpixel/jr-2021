      ...
      >
        ...
        <div className="lg:pb-0 md:col-span-3 md:row-span-2 px-6">          
          <div className="prose max-w-none pt-15 pb-8">
            ...
            <div className="leadText text-2xl" dangerouslySetInnerHTML={{__html: book.leadText?.html}}></div>
            <div className="bodyText" dangerouslySetInnerHTML={{__html: book.bodyText?.html}}></div>
          </div>
        </div>        
      ...
      <section id="book_buyLinks" className="py-10 bg-gradient-to-r from-yellow-700 via-red-700 to-red-900 my-10">
        <div className="py-10 container mx-auto text-white gap-10 grid grid-cols-3">
          ...
          <div className="col-span-2 gap-4 grid">
            <div>
              <a href={book.amazon} target="_blank" className="font-extrabold block text-lg">Amazon:</a> 
              <div className="block">
            ...
            <div>
              <a href={book.kindle} target="_blank" className="font-extrabold block text-lg">Kindle:</a> 
              <div className="block">
                {retailers.nodes.map((retailer) =>
            ...
            <div>
              <a href={book.barnesAndNoble} target="_blank" className="font-extrabold block text-lg">Barnes &amp; Noble:</a> 
              <div className="block">
                {retailers.nodes.map((retailer) =>
            ...
            <div>
              <a href={book.booksAMillion} target="_blank" className="font-extrabold block text-lg">Books A Million:</a>
              <div className="block">
                {retailers.nodes.map((retailer) =>
            ...
            <div>
              <a href={book.nook} target="_blank" className="font-extrabold block text-lg">Nook:</a> 
              <div className="block">
                {retailers.nodes.map((retailer) =>
                  retailer.title == "NOOK" &&
                    <p className="text-sm">{retailer.description}</p>  
            ...
            <div>
              <a href={book.bookshop} target="_blank" className="font-extrabold block text-lg">Bookshop:</a>
              <div className="block">
                {retailers.nodes.map((retailer) =>
            ...
            <div>
              <a href={book.googlePlay} target="_blank" className="font-extrabold block text-lg">Google Play:</a>
              <div className="block">
                {retailers.nodes.map((retailer) =>
            ...
            <div>
              <a href={book.iBookstore} target="_blank" className="font-extrabold block text-lg">iBookstore:</a>
              <div className="block">
                {retailers.nodes.map((retailer) =>
            ...
            <div><a href={book.indieBound} target="_blank" className="font-extrabold block text-lg">Indie Bound:</a> <div className="block"></div></div>
            <div><a href={book.kobo} target="_blank" className="font-extrabold block text-lg">Kobo:</a> <div className="block"></div></div>
            <div><a href={book.thePoisonedPen} target="_blank" className="font-extrabold block text-lg">The Poisoned Pen:</a> <div className="block"></div></div>
