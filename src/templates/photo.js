      ...
      >
        ...
        <div className="lg:pb-0 md:col-span-3 md:row-span-2 px-6">          
          <div className="prose max-w-none pt-10 pb-8">
            ...
            <div className="bodyText" dangerouslySetInnerHTML={{__html: photoContent.description?.html}}></div>
          </div>
        </div>        
...
export const pageQuery = graphql`
  ...
  query PhotoQuery($id: String!) {
    ...
    photoContent: graphCmsPhoto(id: {eq: $id}) {
      description {
        html
      }
    }
