...
return (
    <div className="contactPages relative">
        ...
        <h2 className="pt-16 text-center light text-2xl lg:text-4xl uppercase font-heading">Ask Jim</h2>
                    ...
                    <div id="jumpNav" className="sticky top-40 rounded-md filterContainer light-mode">
                        ...
                        <div className="jumpNav__menu uppercase font-bold text-xs">                
                            <ul>
                                ...
                                <li className="mb-2"><Link to="/requests">Requests <span className="extender"></span></Link></li>  
                                <li className="mb-2"><Link to="/news-media">News Media <span className="extender"></span></Link></li>  
                                <li className="mb-2"><Link to="/publisher-info">Publisher Info <span className="extender"></span></Link></li>  
                            ...
                            <div className="container px-4 mx-auto">
                                <div className="flex flex-wrap -mx-4">
                                    <div className="w-full px-4 mb-8">
                                        <div>
                                            <p className="mb-6 text-lg text-gray-500 leading-loose">I like hearing from readers and reading your messages. Please note, with my hectic research and writing schedule, I am not always able to respond to every email, but I do read each and every note and will do my best to reply.</p>
                                    ...
                                    <div className="flex flex-wrap -mx-8">
                                        <div className="w-full py-16 px-8 mb-4">
                                            ...
                                            <p className="disclaimer-text inline-block w-3/4 align-top">When you submit a message, you are automatically added to the James Rollins Newsletter. Masked, bulk, post-office, and other fake Email addresses are automatically ignored.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
