                    ...
                    <div id="jumpNav" className="sticky top-40 rounded-md filterContainer light-mode">
                        ...
                        <div className="jumpNav__menu uppercase font-bold text-xs">                
                            <ul>
                                ...
                                <li className="mb-2"><Link to="/publishers" className="active">Publisher Info <span className="extender"></span></Link></li>  
...
export const contactPageQuery = graphql`
  {
    pageContent: graphCmsContactForm(title: {eq: "Publishers"}) {
        title
        email
        link
        notes {
