                ...
                <div id="sidebar" className="flex-shrink invisible xl:visible">              
                    <div id="jumpNav" className="sticky top-40 rounded-md filterContainer light-mode">
                        ...
                        <div className="jumpNav__menu uppercase font-bold text-xs">                
                            <ul>
                                <li className="mb-2"><Link to="/ask-jim" >Ask Jim <span className="extender"></span></Link></li>      
                                ...
                                <li className="mb-2"><Link to="/press-kit" className="active">Press Kit <span className="extender"></span></Link></li>  
                            </ul>
                        </div>
...
export const contactPageQuery = graphql`
  {
    pageContent: graphCmsContactForm(title: {eq: "Press Kit"}) {
        title
        email
        link
        notes {
