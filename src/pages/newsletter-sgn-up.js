                    ...
                    <div id="jumpNav" className="sticky top-40 rounded-md filterContainer light-mode">
                        ...
                        <div className="jumpNav__menu uppercase font-bold text-xs">                
                            <ul>
                                ...
                                <li className="mb-2"><Link to="/newsletter-sign-up" className="active">Newsletter Sign-Up <span className="extender"></span></Link></li>      
...
export const contactPageQuery = graphql`
  {
    pageContent: graphCmsContactForm(title: {eq: "Newsletter Sign-Up"}) {
        title
        email
        link
        notes {
